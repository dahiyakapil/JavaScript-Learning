...
function parent() {
  ...
  console.log(x);
  // not defined in local memory, it will search in its local memory and as it is not present in its local memory then it will search its parent lexical env that is the global scope and the variable x is present in the global scope. So it will print the variable in the console.
}
